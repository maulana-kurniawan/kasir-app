...
<head>
	...
	$tanggalku = $formatter->format($dateTime1);
	$tanggalmu = $formatter->format($dateTime2);
	$tanggalnya = $formatter->format($dateTime3);
	?>
</head>
