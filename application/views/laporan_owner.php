						...
						<div class="col-12">
							<div class="card card-green">
								<div class="card-header">
									<h3 class="card-title">Laporan Owner</h3>
								</div>
								<form action="<?= base_url('laporan/owner/cetak'); ?>" target="_blank">
									<div class="card-body">
										<div class="form-group">
											<label>Owner</label>
											<select id="id_owner" name="id_owner" class="form-control select2 select2-green" data-dropdown-css-class="select2-green" style="width: 100%;">
...
<script>
	$(function() {
		$('#id_owner').select2().val(null).trigger('change');
		$('form').validate({
			rules: {
				id_owner: {
					required: true
